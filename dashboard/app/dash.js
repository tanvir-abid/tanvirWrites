const projectss = [
    {
        ...
        progress: {
            projectName: "Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove.",
        ...
        package: {
            serviceName: 'Thesis writing',
            package_name: 'Full Thesis',
            price: 12000,
            category: 'ultimate',
            cover: 'Comprehensive Thesis Writing Service'
        }
    },
    {
        client: {
